...
class RectangleNavigator:
    ...
    def get_visible_range(self):
        ...
        # Only adjust the last page when moving forward, not backward
        if end == self.total_rectangles and (end - start) < self.visible_rectangles and self.current_page == (self.total_rectangles - 1) // self.visible_rectangles:
