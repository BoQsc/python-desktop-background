...
window.after(100, lambda: window.geometry(f"{window.winfo_width()-1}x{window.winfo_height()}")) # This Quickfix: Reduces overall window width size -1px but triggers <Configure> on application start.
