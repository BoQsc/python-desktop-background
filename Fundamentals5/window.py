...
def update_taskbar(event):
    resized_image = canvas.taskbar_image.resize((canvas.winfo_width(), 50), Image.Resampling.NEAREST)
    ...
    canvas.coords(canvas.taskbar_image_placed, 0, canvas.winfo_height() - 50)
